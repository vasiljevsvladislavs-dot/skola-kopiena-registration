  ...
  <head>
    ...
    <style>
      ...
      body {
        ...
        background:#f6f5f1; font-family:Arial,Helvetica,sans-serif; color:#333;
      }
      ...
      p { margin:0 0 12px 0; }
      a.button {
        display:inline-block; background:#3c7b59; color:#fff !important; text-decoration:none;
        padding:12px 28px; border-radius:6px; font-weight:600; margin-top:24px;
      }
      .footer {
        background:#f6f5f1; text-align:center; padding:20px;
